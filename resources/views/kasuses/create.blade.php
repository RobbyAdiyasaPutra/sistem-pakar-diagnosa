            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form action="{{ route('kasuses.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="solusi" name="solusi" rows="5" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('solusi') }}</textarea>
